...
// injected javascript works, but scripts inside html do not, for whatever reason:

//   const js =  `(function () {
//     setTimeout(() => {
//       document.querySelector('#total').innerText='hello?';  // this WORKS 
//       cb(5,7)
//     },2000)
//   }())`
...
//   <body>
//     <h2>please work</h2>
//     <div id='total'>balls</div>
//     <script>
//       (function () {
//         document.querySelector('#total').innerText="come on...";    //  this DOES NOT WORK
//       //  document.querySelector('#total').innerText=String(cb(5,7));      
//         }())
//     </script>
//   </body>
// </html>`
...
class BridgeWrapperComponent extends Component {
  ...
  render(){
    return(
      <View style={{flex:1}}>
        { this.state.coords ? <WebBridgeEx position={ this.state.coords }/> : <Text style={{fontSize:16}}>Waiting for data...</Text>  }
      </View>
      )
  }
